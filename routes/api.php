...
Route::prefix('emergency')->group(function () {
    Route::get('/', 'EmergencyController@index'); // Obtener todas las emergencias
    Route::get('/excel/reporte', 'EmergencyController@excelReport'); // Exportar emergencias a Excel
    Route::get('/status', 'EmergencyController@getEmergenciesByStatus'); // Obtener emergencias por estado
});
...
Route::prefix('vehiculo')->group(function () {
    ...
    Route::post('/emergency/{idEmergency}/assign', 'VehiculoController@assignVehiclesToEmergency');
    Route::patch('/emergency/{idEmergency}/finish', 'VehiculoController@finishEmergency');
});
...
Route::prefix('bitacora')->group(function () {
    Route::get('/visitors', 'BitacoraController@visitorsWithPendingExit');
    Route::get('/maquinas-disponibles', 'BitacoraController@getAvailableMachines');
    Route::get('/empleados-disponibles', 'BitacoraController@getAvailableEmployees');
    Route::get('/', 'BitacoraController@index'); // Listar todas las bitácoras
    Route::post('/new', 'BitacoraController@store'); // Crear una nueva bitácora
    Route::post('/reporte', 'BitacoraController@bitacoraPersonal'); // Generar reporte
    Route::get('/validate', 'BitacoraController@validateEntryExit'); // Validar entrada/salida de personal
    Route::get('/validate-machine', 'BitacoraController@validateMachineEntryExit'); // Validar entrada/salida de máquina
    Route::get('/excel/reporte', 'BitacoraController@excelReport'); // Exportar a Excel
    Route::patch('/{id}', 'BitacoraController@update'); // Actualizar bitácora
    Route::delete('/{id}', 'BitacoraController@destroy'); // Eliminar bitácora
    Route::get('/{id}', 'BitacoraController@show'); // Mostrar una bitácora específica
});
...
Route::prefix('huella')->group(function () {
    ...
    Route::post('/crear/{id}', 'HuellaController@crearHuella');
});
